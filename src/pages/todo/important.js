...
const Important = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:8000/api/todos/important', {
  ...
  }, [isEdit, isDelete, addCategory, deleteCategory]);
  return (
    <>
      <Layout>
        <div className="grid grid-cols-3 grid-flow-row gap-2">
          <div className={isEdit === true ? 'col-span-2' : 'col-span-3'}>
            <h2 className="text-2xl font-semibold text-gray-700 mb-6">Important</h2>
